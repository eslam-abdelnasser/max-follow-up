...
use App\Models\Team ;
use App\Models\TeamDescripiton ;
...
class TeamController extends Controller
{
    ...
    public function index()
    {
        //
        $team =  Team::all();
        return view('admin.team.index')->withTeam($team);
    }
    ...
    public function create()
    {
        ...
        return view('admin.team.create')->withLanguages($this->languages);
    }
    ...
    public function store(Request $request)
    {
        ...
        foreach ($this->languages as $language){
            $teamDescripiton = new TeamDescripiton();
            $teamDescripiton->lang_id = $language->id;
            $teamDescripiton->team_id = $team->id;
...
//        dd($team);
        return view('admin.team.edit')->withLanguages($this->languages)->withTeam($team);
    }
    ...
    public function destroyAll(Request $request){
        ...
        Team::whereIn('id',explode(',',$request->items))->delete();
