...
use App\Models\BoardTrusteesDescription ;
use File ;
use Image ;
class BoardTrusteesController extends Controller
{
    ...
    {
        //
        $team =  BoardTrustees::all();
        return view('admin.board-trustees.index')->withTeam($team);
    ...
    {
        //
        return view('admin.board-trustees.create')->withLanguages($this->languages);
    }
    ...
    public function store(Request $request)
    {
        ...
        $dir = public_path().'/uploads/board-trustees/';
        ...
        foreach ($this->languages as $language){
            $teamDescripiton = new BoardTrusteesDescription();
            $teamDescripiton->lang_id = $language->id;
            $teamDescripiton->board_trustees_id = $team->id;
    ...
    {
        //
        $team = BoardTrustees::find($id);

//        dd($team);
        return view('admin.board-trustees.edit')->withLanguages($this->languages)->withTeam($team);
    }
        ...
        foreach ($this->languages as $language){
            foreach($team->description  as $description){
                if($description->lang_id == $language->id){
                    ...
                    $description->board_trustees_id = $team->id;
    ...
    public function destroyAll(Request $request){
        ...
        BoardTrustees::whereIn('id',explode(',',$request->items))->delete();
