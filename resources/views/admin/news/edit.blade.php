                ...
                <div class="portlet-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            {{Form::open(['route' => ['news.update',$new->id] , 'method' => 'put','files'=>true]) }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group margin-top-10">
                                        <select class="form-control input-medium" name="status">
                                            ...
                                            <option value="1" {{$new->status == 1 ? 'selected' : ''}} >{{trans('admin/services.enable')}}</option>
                                            <option value="0" {{$new->status == 0 ? 'selected' : ''}} >{{trans('admin/services.disable')}}</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="{{asset('uploads/news/790x433/'.$new->image_url)}}" alt="" /> </div>
