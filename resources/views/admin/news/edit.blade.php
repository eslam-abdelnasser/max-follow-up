        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('admin/school.edit_news')}} </div>
                    <div class="tools">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group margin-top-10">
                                        <select class="form-control input-medium" name="homepage_status">
                                            ...
                                            <option value="1" {{$news->home_page_status == 1 ? 'selected' : ''}} >{{trans('admin/services.display')}}</option>
                                            <option value="0" {{$news->home_page_status == 0 ? 'selected' : ''}}>{{trans('admin/services.not_display')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group margin-top-10">
                                        <select class="form-control input-medium" name="status">
                                            ...
                                            <option value="1" {{$news->status == 1 ? 'selected' : ''}} >{{trans('admin/services.enable')}}</option>
                                            <option value="0" {{$news->status == 0 ? 'selected' : ''}} >{{trans('admin/services.disable')}}</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="{{asset('uploads/news/540x370/'.$news->image_url)}}" alt="" /> </div>
