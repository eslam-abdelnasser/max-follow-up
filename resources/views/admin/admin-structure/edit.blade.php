                ...
                <div class="portlet-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            {{Form::open(['route' => ['admin-structure.update',$team->id] , 'method' => 'put','files'=>true]) }}
                            ...
                            <div class="portlet light ">
                             ...
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label> years of exerience </label>
                                    <div class="input-group">
                                                        <span class="input-group-addon input-circle-left">
                                                            <i class="fa fa-align-justify"></i>
                                                        </span>
                                        <input type="number" name="years" value="{{$team->years}}" id="years" class="form-control input-circle-right" placeholder="{{trans('admin/services.slug')}} "> </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="{{asset('uploads/admin-structure/337x335/'.$team->image_url)}}" alt="" /> </div>
