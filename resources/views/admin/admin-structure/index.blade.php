                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <button id="sample_editable_1_new" onclick="location.href ='{{route('admin-structure.create')}}'" class="btn sbold green"> {{trans('admin/blog.add_new')}}
                    ...
                    {!! Form::open(['route' => ['admin-structure.destroy.all'] , 'method' => 'delete', 'id'=>'form-delete']) !!}
                        ...
                        @foreach($team as $singleTeam)
                            <tr class="odd gradeX">
                                ...
                                <td class="text-center vcenter">
                                    <a href="{{route('admin-structure.edit',$singleTeam->id)}}" title="{{trans('admin/services.edit')}}"><i class="fa fa-edit"></i></a>
                                    {!! Form::open(['route' => ['admin-structure.destroy',$singleTeam->id] , 'method' => 'delete','style'=>'display: inline','id'=>'Form'.$singleTeam->id]) !!}
