...
@section('title', trans('admin/school.laboratory'))
...
@section('page_title',trans('admin/school.laboratory'))
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> {{trans('admin/school.laboratory_table')}}</span>
                    </div>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <button id="sample_editable_1_new" onclick="location.href ='{{route('laboratories.create')}}'" class="btn sbold green"> {{trans('admin/school.add_new_laboratory')}}
                    ...
                    {!! Form::open(['route' => ['laboratories.destroy.all'] , 'method' => 'delete', 'id'=>'form-delete']) !!}
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th>#</th>
                            <th class="text-center"> {{trans('admin/school.laboratory_title')}} </th>
                        ...
                        @foreach($laboratories as $laboratory)
                            <tr class="odd gradeX">
                                <td>
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        <input type="checkbox" name="checkbox[]" class="checkboxes sub_chk" value="{{$laboratory->id}}" data-id="{{$laboratory->id}}" />
                                        <span></span>
                                    </label>
                                </td>
                                ...
                                <td class="text-center vcenter">
                                    <span class="label label-sm label-{{$laboratory->home_page_status == 0 ? 'danger' : 'success'}}"> {{$laboratory->home_page_status == 0 ? 'inactive' : 'active'}} </span>

                                </td>
                                <td class="text-center">
                                    <span class="label label-sm label-{{$laboratory->status == 0 ? 'danger' : 'success'}}"> {{$laboratory->status == 0 ? 'inactive' : 'active'}} </span>
                                </td>
                                <td class="text-center vcenter">
                                    <a href="{{route('laboratories.edit',$laboratory->id)}}" title="{{trans('admin/services.edit')}}"><i class="fa fa-edit"></i></a>
                                    {!! Form::open(['route' => ['laboratories.destroy',$laboratory->id] , 'method' => 'delete','style'=>'display: inline','id'=>'Form'.$laboratory->id]) !!}
                                    <a href="javascript:{}" onclick='document.getElementById("Form{{$laboratory->id}}" ).submit();' title="{{trans('admin/services.delete')}}"><i class="fa fa-trash"></i></a>
                                    {!! Form::close() !!}
                                </td>
