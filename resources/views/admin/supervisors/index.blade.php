            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> {{trans('admin/school.supervisor_table')}}</span>
                    </div>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <button id="sample_editable_1_new" onclick="location.href ='{{route('supervisors.create')}}'" class="btn sbold green"> {{trans('admin/school.add_new_supervisor')}}
                    ...
                    {!! Form::open(['route' => ['supervisors.destroy.all'] , 'method' => 'delete', 'id'=>'form-delete']) !!}
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($supervisors as $supervisor)
                            <tr class="odd gradeX">
                                <td>
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        <input type="checkbox" name="checkbox[]" class="checkboxes sub_chk" value="{{$supervisor->id}}" data-id="{{$supervisor->id}}" />
                                        <span></span>
                                    </label>
                                </td>
                                <td>{{$supervisor->id}}</td>
                                ...
                                <td class="text-center vcenter">
                                    <a href="{{route('supervisors.edit',$supervisor->id)}}" title="{{trans('admin/services.edit')}}"><i class="fa fa-edit"></i></a>
                                    {!! Form::open(['route' => ['supervisors.destroy',$supervisor->id] , 'method' => 'delete','style'=>'display: inline','id'=>'Form'.$supervisor->id]) !!}
                                    <a href="javascript:{}" onclick='document.getElementById("Form{{$supervisor->id}}" ).submit();' title="{{trans('admin/services.delete')}}"><i class="fa fa-trash"></i></a>
                                    {!! Form::close() !!}
                                </td>
