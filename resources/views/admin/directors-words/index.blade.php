                ...
                <div class="portlet-body">
                    <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            {{Form::open(['route' => ['admin.director-words.update',$director->id] , 'method' => 'put','files'=>true]) }}
                            <div class="tab-content">

                                @foreach($director->description as $description)
                                        ...
                                        <div class="col-md-9">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    @if(isset($director->image_url))
                                                        <img src="{{asset('uploads/director-words/'.$director->image_url)}}" alt="" />
                                                     @else
