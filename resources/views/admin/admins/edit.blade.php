            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase"> {{trans('admin/admins/create.edit_admin')}}</span>
                    </div>
                    <div class="actions">
                        <div class="btn-group">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control input-circle-right" placeholder="{{trans('admin/admins/create.name')}}" value="{{$admin->name}}"> </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="email" id="email" class="form-control input-circle-right" placeholder="{{trans('admin/admins/create.email')}}" value="{{$admin->email}}"> </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control input-circle-right" placeholder="{{trans('admin/admins/create.phone')}}" value="{{$admin->phone}}"> </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="job_title" id="hob_title" class="form-control input-circle-right" placeholder="{{trans('admin/admins/create.job_title')}}" value="{{$admin->job_title}}"> </div>
                            </div>
                        </div>
