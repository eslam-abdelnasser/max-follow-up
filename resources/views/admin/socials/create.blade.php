                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="name" value="{{old('name')}}" id="site_url" class="form-control input-circle-right" placeholder="name"> </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="url" value="{{old('url')}}" id="title" class="form-control input-circle-right" placeholder="Url"> </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="icon" value="{{old('icon')}}" id="title" class="form-control input-circle-right" placeholder="Icon"> </div>
                                                </div>
