            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> {{trans('admin/school.teacher_table')}}</span>
                    </div>
                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <button id="sample_editable_1_new" onclick="location.href ='{{route('teachers.create')}}'" class="btn sbold green">{{trans('admin/school.add_new_teacher')}}
                    ...
                    {!! Form::open(['route' => ['teachers.destroy.all'] , 'method' => 'delete', 'id'=>'form-delete']) !!}
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        <tr>
                            ...
                            <th>#</th>
                            <th class="text-center"> {{trans('admin/school.teacher_name')}} </th>
                            <th class="text-center"> {{trans('admin/school.teacher_job_title')}} </th>
                        ...
                        @foreach($teachers as $teacher)
                            <tr class="odd gradeX">
                                <td>
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        <input type="checkbox" name="checkbox[]" class="checkboxes sub_chk" value="{{$teacher->id}}" data-id="{{$teacher->id}}" />
                                        <span></span>
                                    </label>
                                </td>
                                ...
                                <td class="text-center">
                                    <span class="label label-sm label-{{$teacher->status == 0 ? 'danger' : 'success'}}"> {{$teacher->status == 0 ? 'inactive' : 'active'}} </span>
                                </td>
                                <td class="text-center vcenter">
                                    <a href="{{route('teachers.edit',$teacher->id)}}" title="{{trans('admin/services.edit')}}"><i class="fa fa-edit"></i></a>
                                    {!! Form::open(['route' => ['teachers.destroy',$teacher->id] , 'method' => 'delete','style'=>'display: inline','id'=>'Form'.$teacher->id]) !!}
                                    <a href="javascript:{}" onclick='document.getElementById("Form{{$teacher->id}}" ).submit();' title="{{trans('admin/services.delete')}}"><i class="fa fa-trash"></i></a>
                                    {!! Form::close() !!}
                                </td>
