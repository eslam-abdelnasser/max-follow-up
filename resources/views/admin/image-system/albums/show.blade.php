...
@section('content')
    ...
    <div class="portfolio-content portfolio-1">
        ...
        <div id="js-grid-juicy-projects" class="cbp">
            ...
            <div class="cbp-item {{$gallery->type == 'accreditation' ? 'accreditation' : 'small-images'}}">
                <div class="cbp-caption">
                    <div class="cbp-caption-defaultWrap">

                            <img src="{{asset('uploads/galleries/types/600x600/'.$gallery->image_url)}}" alt="">

                    </div>
                    <div class="cbp-caption-activeWrap">
                        <div class="cbp-l-caption-alignCenter">
                            <div class="cbp-l-caption-body">
                                <a href="{{route('images.delete',$gallery->id)}}" class="btn red uppercase btn red uppercase" rel="nofollow">{{trans('admin/services.delete')}}</a>

                                 <a href="{{asset('uploads/galleries/types/1200x900/'.$gallery->image_url)}}" class="cbp-lightbox cbp-l-caption-buttonRight btn red uppercase btn red uppercase" data-title="Dashboard<br>by Paul Flavius Nechita">{{trans('admin/galleries.view_larger')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
