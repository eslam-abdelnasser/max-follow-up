                                        ...
                                        <div class="entry-content p-20 pr-10">
                                            <div class="entry-meta media mt-0 no-bg no-border">
                                                <div class="entry-date media-left text-center flip bg-theme-colored pt-5 pr-15 pb-5 pl-15">
                                                    <ul>
                                                        <li class="font-16 text-white font-weight-600">{{ date('d' , strtotime($singleNew->created_at)) }}</li>
                                                        <li class="font-12 text-white text-uppercase">{{ date('F' , strtotime($singleNew->created_at)) }}</li>
                                                    </ul>
                                                </div>
                                            ...
                                            <a href="{{route('news.details',$description->slug)}}" class="btn-read-more">{{trans('front.read_more')}}</a>
